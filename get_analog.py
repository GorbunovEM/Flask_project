...
def get_analog(id ,data):
    ...
    try:
        ...
        analog_0 = [[newlist_0[n_0 - 1]["Project"], newlist_0[n_0 - 1]["id3"], newlist_0[n_0 - 1]["Room"], newlist_0[n_0 - 1]["Area1"],newlist_0[n_0 - 1]["Price"], newlist_0[n_0 - 1]["Date_finish"]],
                    [newlist_0[n_0]["Project"], newlist_0[n_0]["id3"], newlist_0[n_0]["Room"], newlist_0[n_0]["Area1"], newlist_0[n_0]["Price"], newlist_0[n_0]["Date_finish"]],
                    [newlist_0[n_0 + 1]["Project"], newlist_0[n_0 + 1]["id3"], newlist_0[n_0 + 1]["Room"], newlist_0[n_0 + 1]["Area1"], newlist_0[n_0 + 1]["Price"], newlist_0[n_0 + 1]["Date_finish"]]]
    except:
    ...
    try:
        ...
        analog_1 = [[newlist_1[n_1 - 1]["Project"], newlist_1[n_1 - 1]["id3"],newlist_1[n_1 - 1]["Room"], newlist_1[n_1 - 1]["Area1"], newlist_1[n_1 - 1]["Price"], newlist_1[n_1 - 1]["Date_finish"]],
                    [newlist_1[n_1]["Project"], newlist_1[n_1]["id3"], newlist_1[n_1]["Room"], newlist_1[n_1]["Area1"], newlist_1[n_1]["Price"], newlist_1[n_1]["Date_finish"]],
                    [newlist_1[n_1 + 1]["Project"], newlist_1[n_1 + 1]["id3"],newlist_1[n_1 + 1]["Room"], newlist_1[n_1 + 1]["Area1"], newlist_1[n_1 + 1]["Price"], newlist_1[n_1 + 1]["Date_finish"]]]
    except:
    ...
    try:
        ...
        analog_2 = [[newlist_2[n_2 - 1]["Project"], newlist_2[n_2 - 1]["id3"],newlist_2[n_2 - 1]["Room"], newlist_2[n_2 - 1]["Area1"], newlist_2[n_2 - 1]["Price"], newlist_2[n_2 - 1]["Date_finish"]],
                    [newlist_2[n_2]["Project"], newlist_2[n_2]["id3"], newlist_2[n_2]["Room"], newlist_2[n_2]["Area1"], newlist_2[n_2]["Price"], newlist_2[n_2]["Date_finish"]],
                    [newlist_2[n_2 + 1]["Project"], newlist_2[n_2 + 1]["id3"],newlist_2[n_2 + 1]["Room"], newlist_2[n_2 + 1]["Area1"], newlist_2[n_2 + 1]["Price"], newlist_2[n_2 + 1]["Date_finish"]]]
    except:
    ...
    try:
        ...
        analog_3 = [[newlist_3[n_3 - 1]["Project"], newlist_3[n_3 - 1]["id3"],newlist_3[n_3 - 1]["Room"], newlist_3[n_3 - 1]["Area1"], newlist_3[n_3 - 1]["Price"], newlist_3[n_3 - 1]["Date_finish"]],
                    [newlist_3[n_3]["Project"], newlist_3[n_3]["id3"], newlist_3[n_3]["Room"], newlist_3[n_3]["Area1"], newlist_3[n_3]["Price"], newlist_3[n_3]["Date_finish"]],
                    [newlist_3[n_3 + 1]["Project"], newlist_3[n_3 + 1]["id3"],newlist_3[n_3 + 1]["Room"], newlist_3[n_3 + 1]["Area1"], newlist_3[n_3 + 1]["Price"], newlist_3[n_3 + 1]["Date_finish"]]]
    except:
    ...
    try:
        ...
        analog_4 = [[newlist_4[n_4 - 1]["Project"], newlist_4[n_4 - 1]["id3"],newlist_4[n_4 - 1]["Room"], newlist_4[n_4 - 1]["Area1"], newlist_4[n_4 - 1]["Price"], newlist_4[n_4 - 1]["Date_finish"]],
                    [newlist_4[n_4]["Project"], newlist_4[n_4]["id3"], newlist_4[n_4]["Room"], newlist_4[n_4]["Area1"], newlist_4[n_4]["Price"], newlist_4[n_4]["Date_finish"]],
                    [newlist_4[n_4 + 1]["Project"], newlist_4[n_4 + 1]["id3"],newlist_4[n_4 + 1]["Room"], newlist_4[n_4 + 1]["Area1"], newlist_4[n_4 + 1]["Price"], newlist_4[n_4 + 1]["Date_finish"]]]
    except:
